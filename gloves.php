...
<section class="services-block-area section-padding-100-0">
    <div class="container">
        <div class="headlines">
            <h1 class="font-bold text-center" style="font-size: 48px; color: #006;">Featured Gloves</h1>
            <hr>
            <br>
        </div>
        <div class="row">
