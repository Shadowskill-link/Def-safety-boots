...
<section class="info-hero-2 section-padding-100 ">
<div class="container">
<div class="card">
  <div class="card-header" style="background-color: #006;">
   <strong class="text-white">Information</strong>
  </div>
  <div class="card-body">
    <h5 class="card-title">Rules to become Distributor</h5>
    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, harum dignissimos. Optio labore corporis expedita odit quo cupiditate vero voluptate reprehenderit voluptatum neque accusamus magnam sapiente repellendus repellat, sunt aspernatur.</p>
    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, harum dignissimos. Optio labore corporis expedita odit quo cupiditate vero voluptate reprehenderit voluptatum neque accusamus magnam sapiente repellendus repellat, sunt aspernatur.</p>
  ...
  <div class="form-group">
  <div class="form-group">
  <select class="grid-4 form-control" id="country" name="country"><option value="">Seleccionar pa&#237;s</option>
...
<option value="ZW">Zimbabue</option>
  ...
  <input type="submit" class="btn pixel-btn" value="Submit">  
</form>
    
    <hr>
    <h4>Do you are  any  procurment?</h4>
    <h6>Request a Quote</h6>
    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, harum dignissimos. Optio labore corporis expedita odit quo cupiditate vero voluptate reprehenderit voluptatum neque accusamus magnam sapiente repellendus repellat, sunt aspernatur.</p>
    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, harum dignissimos. Optio labore corporis expedita odit quo cupiditate vero voluptate reprehenderit voluptatum neque accusamus magnam sapiente repellendus repellat, sunt aspernatur.</p>
    <a href="#" class="btn pixel-btn">Describe</a>
  </div>
  <br>
