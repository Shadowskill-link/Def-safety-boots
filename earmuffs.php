...
$stmt = $pdo->prepare('SELECT * FROM produtos WHERE categoria_id = 3');
...
$total_products = $pdo->query('SELECT * FROM produtos WHERE categoria_id = 3')->rowCount();
?>

<?=template_header('Earmufs')?>
