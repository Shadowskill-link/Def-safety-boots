                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-lg-12">
                        <div class="welcome-text">
                            ...
                            <h4 data-animation="fadeInUp" data-delay="500ms"> <span>Established brand that sources high
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-lg-9">
                        <div class="welcome-text">
                            <h2 data-animation="fadeInUp" data-delay="300ms"> Quick turn around times as all items are
...
<section class="info-hero2 section-padding-100 ">
    <div class="">
		...
		<?php foreach($recently_added_products as $product): ?>
            ...
            <div class="item">
                <a href="index.php?page=product&id=<?=$product['id_produto']?>"><img src="img/<?=$product['imagem_produto']?>" alt=""></a>
                <h4 class="text-muted mt-15"><?=$product['nome_produto']?></h4>
            </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="section-heading text-center">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut rutrum quis sem sed pharetra. Morbi
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="single-team-member mb-100"><img src="img/bg-img/8.png" alt=""><!-- Hover Text -->
                    <div class="hover-text d-flex align-items-end justify-content-center text-center">
                        <div class="hover--">
                            <h6>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi, illum minus. Iste quas.
                            </h6>
