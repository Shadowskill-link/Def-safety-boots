...
<section class="services-block-area section-padding-100-0">
    <div class="container">
        <div class="headlines">
            <h1 class="font-bold text-center" style="font-size: 48px; color: #006;">Reflective Vests</h1>
            <hr>
            <br>
        </div>
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50 wow fadeInUp" data-wow-delay="100ms">
                    <a href=""><img src="img/reflectivevests/92.png"></a>
                    <h4 class="mt-15 text-center">DEF Forte Brown</h4>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50wow fadeInUp" data-wow-delay="300ms">
                    ...
                    <h4 class="mt-15 text-center">DEF chelsea</h4>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50 wow fadeInUp" data-wow-delay="500ms">
                    ...
                    <h4 class="mt-15 text-center">DEF TEC</h4>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50 wow fadeInUp" data-wow-delay="500ms">
                    ...
                    <h4 class="mt-15 text-center">DEF FORTE</h4>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50 wow fadeInUp" data-wow-delay="500ms">
                    ...
                    <h4 class="mt-15 text-center">DEF BASIX</h4>
