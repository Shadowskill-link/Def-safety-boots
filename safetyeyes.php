...
<section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(img/banner/eyes.png);">
...
<section class="services-block-area section-padding-100-0">
    <div class="container">
        <div class="row">
        <?php $sql ="select * from produtos where categoria_id=4";
		...
		{   ?>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50 wow fadeInUp" data-wow-delay="100ms">
                    <a href="product-details.php"><img src="img/eyesafety/<?php echo htmlentities($result->imagem_produto);?>"></a>
