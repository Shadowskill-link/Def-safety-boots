...
<section class="services-block-area section-padding-100-0">
    <div class="container">
        <div class="headlines">
            <h1 class="font-bold text-center" style="font-size: 48px; color: #006;">Featured eyewears</h1>

            <a href="safetyboots.php" class="btn pixel-btn">know eywears</a>
            <hr>
            <br>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50 wow fadeInUp" data-wow-delay="500ms">
                    <img src="img/eyesafety/IMG_20220711_142825_424.png">
                    <h4 class="mt-15">DEF FORTE</h4>
                    <p>CODE:DE-6550 S3 Safety Boot</p>
                    <a href="" class="btn pixel-btn">ADD TO BASKET</a>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-service-block mb-50 wow fadeInUp" data-wow-delay="500ms">
                    <img src="img/eyesafety/IMG_20220711_143012_609.png">
                    <h4 class="mt-15">DEF FORTE</h4>
                    <p>CODE:DE-6550 S3 Safety Boot</p>
                    <a href="" class="btn pixel-btn">ADD TO BASKET</a>
                </div>
